...
import { countPrsInStack, createPrBodyFooter } from '../create_pr_body_footer';
...
export function stripPrBodyFooter(body: string | undefined): string {
  ...
  // Match any footer section: "#### <title>" followed by PR list,
  // optionally ending with the old Charcoal attribution line.
  // Handles both old (indented + attribution) and new (flat, no attribution) formats.
  const footerPattern =
