...
describe('stripPrBodyFooter', () => {
  const existingBodyWithFooter = `Fix the bug
...
This tree was auto-generated by [Charcoal](https://github.com/danerwilliams/charcoal)`;
  ...
  const existingBodyWithoutFooter = `Fix the bug`;

  it('removes the footer when present', () => {
    expect(stripPrBodyFooter(existingBodyWithFooter)).equal(
      existingBodyWithoutFooter
    );
  });

  it('is a no-op when there is no footer', () => {
    expect(stripPrBodyFooter(existingBodyWithoutFooter)).equal(
      existingBodyWithoutFooter
    );
  });

  it('returns empty string for undefined body', () => {
    expect(stripPrBodyFooter(undefined)).equal('');
  });
});

describe('updatePrBodyFooter', () => {
  // Footer must include leading newlines to match the format produced by createPrBodyFooter
  const newFooter = `
...
![CleanShot 2024-02-08 at 21 18 49@2x](https://github.com/danerwilliams/charcoal/assets/22798229/3821e8dc-d6df-4e1d-bd4b-2ed5ccf7aec9)`;
    ...
    describe('and there are duplicate footers (e.g., from Jira bot inserting content)', () => {
      it('removes all duplicates and adds the new footer', () => {
        const existingBodyWithDuplicates = `Parse the header...
...
[EDGE-1321]: https://canva.atlassian.net/browse/EDGE-1321
...
This tree was auto-generated by [Charcoal](https://github.com/danerwilliams/charcoal)`;
        ...
        const expectedBody = `Parse the header...
...
[EDGE-1321]: https://canva.atlassian.net/browse/EDGE-1321`;
        ...
        const updatedPrBody = updatePrBodyFooter(
          existingBodyWithDuplicates,
          newFooter
        );

        expect(updatedPrBody).equal(expectedBody + newFooter);
      });
    });
  });
});
